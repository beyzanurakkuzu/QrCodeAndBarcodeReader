...
import com.beyzaakkuzu.qrcodereader.extension.toStringId
import com.beyzaakkuzu.qrcodereader.extension.unsafeLazy
import com.beyzaakkuzu.qrcodereader.feature.BaseActivity
import com.beyzaakkuzu.qrcodereader.feature.barcode.BarcodeActivity
import com.beyzaakkuzu.qrcodereader.feature.tabs.create.barcode.*
import com.beyzaakkuzu.qrcodereader.feature.tabs.create.qr.*
import com.beyzaakkuzu.qrcodereader.model.Barcode
import com.beyzaakkuzu.qrcodereader.model.schema.App
...
class CreateBarcodeActivity : BaseActivity(), AppAdapter.Listener {
    ...
    private fun showToolbarMenu() {
        val menuId = when (barcodeSchema) {
            ...
            BarcodeSchema.PHONE, BarcodeSchema.SMS-> R.menu.menu_create_qr_code_phone
    ...
    private fun showFragment() {
        val fragment = when {
            ...
            barcodeFormat == BarcodeFormat.QR_CODE && barcodeSchema == BarcodeSchema.BOOKMARK -> BookmarkFragment()
            ...
            barcodeFormat == BarcodeFormat.QR_CODE && barcodeSchema == BarcodeSchema.EMAIL -> EmailFragment()
            ...
            barcodeFormat == BarcodeFormat.QR_CODE && barcodeSchema == BarcodeSchema.APP -> AppFragment()
